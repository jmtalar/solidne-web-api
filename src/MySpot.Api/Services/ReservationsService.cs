...
public class ReservationsService
{
    ...
    public Guid? Create(CreateReservation command)
    {
        ...
        var reservation = new Reservation(
            ...
            new ValueObjects.Date(command.Date)
        );
    ...
    public bool Update(ChangeReservationLicensePlate command)
    {
        ...
        var existingReservation = weeklyParkingSpot.Reservations.SingleOrDefault(x =>
            x.Id == command.ReservationId
        );
    ...
    public bool Delete(DeleteReservation command)
    {
        ...
        var existingReservation = weeklyParkingSpot.Reservations.FirstOrDefault(x =>
            x.Id == command.ReservationId
        );
        if (existingReservation is null)
        {
